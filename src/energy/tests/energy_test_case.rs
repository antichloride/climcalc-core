...
pub fn create_energy(start_year: u32, end_year: u32) -> Energy{
    ...
    // [start:inputs]
    energy.inputs.rf_A__k__m2.set(6369.158653846154, 8875.352163461539, 0.0, 467.1237980769231);
    energy.inputs.sol_rf_suitable_A_part.set(0.0008005498039891716, 0.0008005498039891716, 0.0, 0.0008005498039891716);
    ...
    energy.inputs.sol_os_installed_A__ha.set(0.0, 78.2451923076923, 0.0, 0.0);
	...
	energy.inputs.sol_os_installed_A__ha.public.add_measure("sol_os_installed_A__ha", 2024, 2025, -20.0);
