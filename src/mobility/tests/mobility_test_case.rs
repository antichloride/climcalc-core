...
pub fn create_mobility(start_year: u32, end_year: u32) -> Mobility{
	...
	//mobility.inputs.n_bev__k__.private.add_measure("n_bev__k__", 2024, 2035, 20.0);

	//Industry
	//mobility.inputs.n_cars__k__.industry.add_measure("n_cars__k__", 2024, 2025, -20.0);
	//mobility.inputs.n_bev__k__.industry.add_measure("n_bev__k__", 2024, 2025, -19.999999999999993);
